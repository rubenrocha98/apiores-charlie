...
public class NewLevel {
    ...
    private MoveObstacles[] firstTrack = new MoveObstacles[4];
    ...
    private MoveObstacles[] fifthTrack = new MoveObstacles[7];
    ...
    public NewLevel() {
        ...
        levelObjective = new Rectangle(200, 10, 25, 25);
    ...
    public void start() throws InterruptedException {
        ...
        while(true) {
            ...
            createObstacles(firstTrack, 10 , 245, 400);
            createObstacles(secondTrack,12, 320, 350);
            createObstacles(thirdTrack, -15, 150, 250);
            createObstacles(fourthTrack,9, 245, 150);
            createObstacles(fifthTrack,-12, 115, 100);
            ...
            while (!dead && !cleared) {
                ...
                for (MoveObstacles obstacle : fifthTrack) {
                    obstacle.moveCarLeft();
                    checkDead(obstacle);
                }
                Thread.sleep(75);
